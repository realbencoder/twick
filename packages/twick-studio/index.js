...
function Toolbar({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sidebar", children: mergedTools.map((tool) => {
...
const StudioHeader = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("header", { className: "header", children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex-container", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex-container", style: { gap: "0.5rem" }, children: [
...
const _MediaManagerSingleton = class _MediaManagerSingleton {
  ...
  static getInstance() {
    if (!_MediaManagerSingleton.instance) {
      _MediaManagerSingleton.instance = new VideoEditor.BrowserMediaManager();
    }
...
function MediaProvider({ children }) {
  const [videoState, setVideoState] = react.useState(initialMediaState);
  const [audioState, setAudioState] = react.useState(initialMediaState);
  const [imageState, setImageState] = react.useState(initialMediaState);
...
const mediaConfigs = {
  video: {
    ...
    createElement: (url, parentSize) => new timeline.VideoElement(url, parentSize),
    updateElement: async (element, url) => {
      if (element instanceof timeline.VideoElement) {
        element.setSrc(url);
  ...
  audio: {
    ...
    createElement: (url, _parentSize) => new timeline.AudioElement(url),
    updateElement: async (element, url) => {
  ...
  image: {
    ...
    createElement: (url, parentSize) => new timeline.ImageElement(url, parentSize),
    updateElement: async (element, url) => {
      if (element instanceof timeline.ImageElement) {
        element.setSrc(url);
...
const useAudioPreview = () => {
  ...
  const togglePlayPause = react.useCallback((item) => {
...
const AudioPanel = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "panel-container", children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "media-content", children: [
      ...
      onLoadMore && canLoadMore && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "panel-section", children: /* @__PURE__ */ jsxRuntime.jsx(
        "button",
        {
          type: "button",
...
const AudioPanelContainer = (props) => {
  const [activeSource, setActiveSource] = react.useState("user");
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "panel-section", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        "button",
        {
          type: "button",
    ...
    activeSource === "user" ? /* @__PURE__ */ jsxRuntime.jsx(AudioUserAssetsSection, { ...props }) : /* @__PURE__ */ jsxRuntime.jsx(AudioPublicAssetsSection, {})
  ] });
};
...
function AudioPublicAssetsSection() {
  ...
  const [publicItems, setPublicItems] = react.useState([]);
  ...
  const throttledLoadPublicAssets = react.useMemo(
    () => VideoEditor.throttle(loadPublicAssets, 1e3),
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "panel-section", children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "property-row", children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "property-row-label", children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: "property-label", children: "Provider" }) }),
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "property-row-control", children: /* @__PURE__ */ jsxRuntime.jsxs(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx("option", { value: "all", children: "All providers" }),
              providerConfigs.filter((p) => p.enabled).map((p) => /* @__PURE__ */ jsxRuntime.jsx("option", { value: p.id, children: p.label }, p.id))
            ]
          }
        ) })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "property-row-control", children: /* @__PURE__ */ jsxRuntime.jsx(
        SearchInput,
        {
...
function ImagePanel({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "panel-container", children: [
    ...
    showAddByUrl && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "panel-section", children: /* @__PURE__ */ jsxRuntime.jsx(UrlInput, { type: "image", onSubmit: onUrlAdd }) }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "media-content", children: [
...
function ImagePanelContainer(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    activeSource === "user" ? /* @__PURE__ */ jsxRuntime.jsx(ImageUserAssetsSection, { ...props }) : /* @__PURE__ */ jsxRuntime.jsx(ImagePublicAssetsSection, {})
  ] });
}
...
function ImagePublicAssetsSection() {
  ...
  const [publicItems, setPublicItems] = react.useState([]);
  const [publicSearchQuery, setPublicSearchQuery] = react.useState("nature");
  const [isPublicLoading, setIsPublicLoading] = react.useState(false);
  const [page, setPage] = react.useState(1);
...
const useVideoPreview = () => {
  ...
  const togglePlayPause = react.useCallback((item, videoElement) => {
...
function VideoPanel({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "panel-container", children: [
    ...
    showAddByUrl && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex panel-section", children: /* @__PURE__ */ jsxRuntime.jsx(UrlInput, { type: "video", onSubmit: onUrlAdd }) }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "media-content", children: [
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "media-grid", children: (items || []).map((item) => /* @__PURE__ */ jsxRuntime.jsxs(
        "div",
        {
...
function VideoPanelContainer(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    activeSource === "user" ? /* @__PURE__ */ jsxRuntime.jsx(VideoUserAssetsSection, { ...props }) : /* @__PURE__ */ jsxRuntime.jsx(VideoPublicAssetsSection, {})
  ] });
}
...
const useTextPanel = ({
  ...
  const [textContent, setTextContent] = react.useState(DEFAULT_TEXT_PROPS.text);
  const [fontSize, setFontSize] = react.useState(DEFAULT_TEXT_PROPS.fontSize);
  const [selectedFont, setSelectedFont] = react.useState(DEFAULT_TEXT_PROPS.fontFamily);
  const [isBold, setIsBold] = react.useState(DEFAULT_TEXT_PROPS.fontWeight === 700);
  const [isItalic, setIsItalic] = react.useState(DEFAULT_TEXT_PROPS.fontStyle === "italic");
  const [textColor, setTextColor] = react.useState(DEFAULT_TEXT_PROPS.textColor);
  const [strokeColor, setStrokeColor] = react.useState(DEFAULT_TEXT_PROPS.strokeColor);
...
const TEXT_STYLE_PRESETS = [
  ...
  },
  {
    ...
    fontFamily: VideoEditor.AVAILABLE_TEXT_FONTS.MULISH,
    fontSize: 30,
    fontWeight: 500,
    textColor: "#FFFFFF",
    strokeColor: "#000000",
  ...
  },
  {
    ...
    fontFamily: VideoEditor.AVAILABLE_TEXT_FONTS.RUBIK,
    fontSize: 30,
    fontWeight: 600,
    textColor: "#FFFFFF",
    strokeColor: "#000000",
  ...
  },
  {
    ...
    fontFamily: VideoEditor.AVAILABLE_TEXT_FONTS.PLAYFAIR_DISPLAY,
    fontSize: 42,
    fontWeight: 400,
    textColor: "#E5E7EB",
    strokeColor: "#000000",
  ...
  },
  {
    ...
    fontFamily: VideoEditor.AVAILABLE_TEXT_FONTS.POPPINS,
    fontSize: 40,
    fontWeight: 700,
    textColor: "#111827",
    strokeColor: "#000000",
  ...
  },
  {
    ...
    fontFamily: VideoEditor.AVAILABLE_TEXT_FONTS.KUMAR_ONE_OUTLINE,
    fontSize: 48,
    fontWeight: 700,
    textColor: "#000000",
    strokeColor: "#FFFFFF",
...
function TextStylePanel({ addElement }) {
  const createTextFromPreset = async (preset) => {
    const textElement = new timeline.TextElement("Sample").setFontSize(preset.fontSize).setFontFamily(preset.fontFamily).setFontWeight(preset.fontWeight).setFontStyle("normal").setFill(preset.textColor).setStrokeColor(preset.strokeColor).setLineWidth(preset.strokeWidth).setTextAlign("center");
    const nextProps = { ...textElement.getProps() };
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "panel-container", children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "panel-title", children: "Text Style" }),
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "panel-section", children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-style-grid", children: TEXT_STYLE_PRESETS.map((preset) => /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
        type: "button",
        className: "text-style-card",
        onClick: () => handlePresetClick(preset),
        children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-style-preview", children: /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
            style: {
...
const useEffectPanel = ({
  ...
  const selectedEffectKey = react.useMemo(() => {
    var _a;
    if (!selectedElement) return null;
    if (selectedElement.getType() !== timeline.TIMELINE_ELEMENT_TYPE.EFFECT) return null;
  ...
  const handleAddEffect = (key) => {
    const effect = new timeline.EffectElement(key);
    addElement(effect);
  };
  const handleUpdateEffect = (key) => {
    if (!selectedElement) return;
    if (selectedElement.getType() !== timeline.TIMELINE_ELEMENT_TYPE.EFFECT) return;
    const effectElement = selectedElement;
...
function EffectPreview({ effectKey, label }) {
  ...
  if (!src) {
    return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "effect-preview-box-inner flex items-center justify-center text-xs text-neutral-400", children: label });
  }
  return /* @__PURE__ */ jsxRuntime.jsx(
    "img",
    {
...
function EffectStylePanel({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "panel-container", children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "panel-title", children: "Effect Style" }),
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "panel-section", children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "effect-grid", children: EFFECT_OPTIONS.map((effect) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsx(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "effect-preview-box", children: [
            /* @__PURE__ */ jsxRuntime.jsx(EffectPreview, { effectKey: effect.key, label: effect.label }),
            /* @__PURE__ */ jsxRuntime.jsx("div", { className: "effect-preview-label", children: effect.label })
          ] })
        },
        effect.key
      );
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "panel-container captions-panel", children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "captions-panel-header", children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "captions-panel-header-meta", children: [
        captions.length === 0 ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "captions-panel-count", children: "No subtitles yet" }) : null,
        /* @__PURE__ */ jsxRuntime.jsx(
          "button",
          {
            onClick: addCaption,
    ...
    captions.length === 0 ? /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "panel-section captions-panel-empty", children: [
      /* @__PURE__ */ jsxRuntime.jsx("p", { className: "captions-panel-empty-title", children: "Start your first subtitle" }),
      /* @__PURE__ */ jsxRuntime.jsx("p", { className: "captions-panel-empty-subtitle", children: "Use the button above to add the first subtitle block for the active track." }),
      /* @__PURE__ */ jsxRuntime.jsx(
        "button",
        {
          onClick: addCaption,
      ...
      tracks: [
        {
          id: "t-edu-text",
          name: "Lesson Text",
          type: timeline.TRACK_TYPES.ELEMENT,
          elements: [
            {
              id: "e-edu-title",
              trackId: "t-edu-text",
      ...
      tracks: [
        {
          ...
          type: timeline.TRACK_TYPES.VIDEO,
          elements: []
        },
        {
          id: "t-demo-callout",
...
const TemplateGalleryPanel = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "panel-container", children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "panel-header", children: /* @__PURE__ */ jsxRuntime.jsx("h3", { children: "Templates" }) }),
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "panel-content", style: { display: "grid", gap: "12px" }, children: templates.map((template) => /* @__PURE__ */ jsxRuntime.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontWeight: 600 }, children: template.name }),
          /* @__PURE__ */ jsxRuntime.jsx("span", { style: { opacity: 0.8, fontSize: "12px" }, children: template.description }),
          /* @__PURE__ */ jsxRuntime.jsx("span", { style: { opacity: 0.6, fontSize: "11px", marginTop: "2px" }, children: template.category })
        ]
      },
      template.id
    )) })
...
const RecordPanel = ({
  ...
  const addToTimeline = async () => {
    ...
    const element = new timeline.VideoElement(mediaUrl, videoResolution).setEnd(5).setName("Screen Recording").setMetadata({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "panel-container", children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "panel-header", children: /* @__PURE__ */ jsxRuntime.jsx("h3", { children: "Record Screen" }) }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "panel-content", style: { display: "grid", gap: "12px" }, children: [
      /* @__PURE__ */ jsxRuntime.jsxs("label", { style: { display: "flex", gap: "8px", alignItems: "center" }, children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          "input",
          {
            type: "checkbox",
      ...
      state !== "recording" ? /* @__PURE__ */ jsxRuntime.jsx("button", { className: "btn-primary", onClick: () => startRecording(withMic), children: "Start Recording" }) : /* @__PURE__ */ jsxRuntime.jsx("button", { className: "btn-ghost", onClick: stopRecording, children: "Stop Recording" }),
      error ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-sm", children: error }) : null,
      mediaUrl ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        /* @__PURE__ */ jsxRuntime.jsx("video", { src: mediaUrl, controls: true, style: { width: "100%", borderRadius: "8px" } }),
        /* @__PURE__ */ jsxRuntime.jsx("button", { className: "btn-primary", onClick: addToTimeline, children: "Add Recording To Timeline" }),
        /* @__PURE__ */ jsxRuntime.jsx("button", { className: "btn-ghost", onClick: clearRecording, children: "Clear Recording" })
      ] }) : null
    ] })
  ] });
};
...
const AnnotationsPanel = ({
  ...
  const addLine = async () => {
    ...
    const element = new timeline.LineElement(SHAPE_COLORS.line, {
  ...
  const addArrow = async () => {
    if (!addElement) return;
    const element = new timeline.ArrowElement(SHAPE_COLORS.arrow, { width: 220, height: 20 }).setEnd(5).setName("Arrow Callout");
    await addElement(element);
  };
  const addBox = async () => {
    if (!addElement) return;
    const element = new timeline.RectElement(SHAPE_COLORS.rect, {
      width: Math.round(videoResolution.width * 0.35),
  ...
  const addCircle = async () => {
    ...
    const element = new timeline.CircleElement(SHAPE_COLORS.circle, radius).setEnd(5).setName("Circle");
    await addElement(element);
  };
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "panel-container", children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "panel-header", children: /* @__PURE__ */ jsxRuntime.jsx("h3", { children: "Shapes" }) }),
    /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx("div", { style: { fontWeight: 600, marginBottom: 2 }, children: "Line" }),
                /* @__PURE__ */ jsxRuntime.jsx("div", { style: { fontSize: 12, opacity: 0.8 }, children: "Draw a straight segment to connect or underline." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntime.jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx("div", { style: { fontWeight: 600, marginBottom: 2 }, children: "Arrow callout" }),
                /* @__PURE__ */ jsxRuntime.jsx("div", { style: { fontSize: 12, opacity: 0.8 }, children: "Emphasize a button or region with a directional arrow." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntime.jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx("div", { style: { fontWeight: 600, marginBottom: 2 }, children: "Box" }),
                /* @__PURE__ */ jsxRuntime.jsx("div", { style: { fontSize: 12, opacity: 0.8 }, children: "Draw attention to important text or UI with a soft highlight." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntime.jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx("div", { style: { fontWeight: 600, marginBottom: 2 }, children: "Circle" }),
                /* @__PURE__ */ jsxRuntime.jsx("div", { style: { fontSize: 12, opacity: 0.8 }, children: "Add a circular callout or highlight area." })
              ]
            }
          )
        ]
...
const ChaptersPanel = (_props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "panel-container", children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "panel-header", children: /* @__PURE__ */ jsxRuntime.jsx("h3", { children: "Chapters" }) }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "panel-content", style: { display: "grid", gap: "10px" }, children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        "input",
        {
      ...
      /* @__PURE__ */ jsxRuntime.jsx("button", { className: "btn-primary", onClick: addChapter, children: "Add Chapter At Playhead" }),
      /* @__PURE__ */ jsxRuntime.jsx("div", { style: { display: "grid", gap: "8px" }, children: chapters.map((chapter) => /* @__PURE__ */ jsxRuntime.jsxs(
        "div",
        {
          className: "btn-ghost",
          style: {
...
const ScriptPanel = ({ videoResolution }) => {
  ...
  const buildTimelineFromScript = async () => {
    ...
    for (let index = 0; index < sections.length; index++) {
      ...
      const textElement = new timeline.TextElement(section).setStart(start).setEnd(end).setName(`Script Section ${index + 1}`).setPosition({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "panel-container", children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "panel-header", children: /* @__PURE__ */ jsxRuntime.jsx("h3", { children: "Script" }) }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "panel-content", style: { display: "grid", gap: "10px" }, children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        "textarea",
        {
      ...
      /* @__PURE__ */ jsxRuntime.jsx("button", { className: "btn-primary", onClick: buildTimelineFromScript, children: "Generate Timeline From Outline" })
    ] })
  ] });
};
const ElementPanelContainer = ({
  ...
  const renderLibrary = () => {
    ...
    switch (selectedTool) {
      ...
      case "templates":
        return /* @__PURE__ */ jsxRuntime.jsx(TemplateGalleryPanel, { studioConfig });
      case "record":
        return /* @__PURE__ */ jsxRuntime.jsx(
          RecordPanel,
          {
...
function TextEffects({
  ...
  const handleUpdateEffect = (props) => {
    if (!selectedElement || !(selectedElement instanceof timeline.TextElement)) return;
    ...
    if (!effect || props.name && props.name !== effect.getName()) {
      effect = new timeline.ElementTextEffect(
        props.name || (currentEffect == null ? void 0 : currentEffect.getName()) || VideoEditor.TEXT_EFFECTS[0].name
      );
      effect.setDelay(0);
...
function Animation({
  ...
  if (!(selectedElement instanceof timeline.TrackElement)) return null;
  ...
  const handleUpdateAnimation = (props) => {
    ...
    if (!animation || props.name && props.name !== animation.getName()) {
      animation = new timeline.ElementAnimation(
        props.name || (currentAnimation == null ? void 0 : currentAnimation.getName()) || VideoEditor.ANIMATIONS[0].name
      );
...
function CaptionPropPanel({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "panel-container", children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "panel-section", children: [
      /* @__PURE__ */ jsxRuntime.jsx("label", { className: "label-dark", children: "Subtitle Style" }),
      /* @__PURE__ */ jsxRuntime.jsx(
        "select",
        {
    ...
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "panel-section", children: /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
        className: "btn-primary w-full",
        onClick: () => {
          if (!track || !(selectedElement instanceof timeline.CaptionElement)) return;
          ...
          allCaptions.forEach((el) => {
            if (el instanceof timeline.CaptionElement) {
              const p = el.getProps() ?? {};
...
function isShapeElement(el) {
  return el != null && (el instanceof timeline.ArrowElement || el instanceof timeline.LineElement || el instanceof timeline.RectElement || el instanceof timeline.CircleElement);
}
function AnnotationStylePanel({
  ...
  const [fill, setFill] = react.useState("#f59e0b");
  ...
  react.useEffect(() => {
    ...
    const currentFill = (props == null ? void 0 : props.fill) ?? (shape instanceof timeline.RectElement || shape instanceof timeline.CircleElement ? shape.getFill() : void 0);
    setFill(fillToHex(currentFill));
    setOpacity(shape.getOpacity() ?? 1);
    if (shape instanceof timeline.RectElement) {
      setRadius(shape.getCornerRadius());
      setThickness(null);
    } else if (shape instanceof timeline.CircleElement) {
      setRadius(shape.getRadius());
      setThickness(null);
    } else if (shape instanceof timeline.LineElement) {
      setThickness((props == null ? void 0 : props.height) ?? 4);
      setRadius((props == null ? void 0 : props.radius) ?? 4);
    } else if (shape instanceof timeline.ArrowElement) {
      setRadius((props == null ? void 0 : props.radius) ?? 4);
      setThickness(null);
    }
  ...
  const handleFillChange = (value) => {
    ...
    setFill(value);
    const props = shape.getProps();
    if (shape instanceof timeline.RectElement || shape instanceof timeline.CircleElement) {
      shape.setFill(value);
    } else {
  ...
  const handleThicknessChange = (value) => {
    if (!shape || !(shape instanceof timeline.LineElement)) return;
    setThickness(value);
    const props = shape.getProps();
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "panel-container", children: /* @__PURE__ */ jsxRuntime.jsx(
    AccordionItem,
    {
      title: "Shape style",
      icon: /* @__PURE__ */ jsxRuntime.jsx(Palette, { className: "icon-sm" }),
      isOpen: styleOpen,
      onToggle: () => setStyleOpen((open) => !open),
      children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "properties-group", children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "panel-section", children: [
          /* @__PURE__ */ jsxRuntime.jsx("label", { className: "label-dark", children: "Color" }),
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "color-control", children: [
            /* @__PURE__ */ jsxRuntime.jsx("label", { className: "label-small", children: "Fill" }),
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "color-inputs", children: [
              /* @__PURE__ */ jsxRuntime.jsx(
                "input",
                {
        ...
        radius !== null && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "panel-section", children: [
          /* @__PURE__ */ jsxRuntime.jsx("label", { className: "label-dark", children: shape instanceof timeline.CircleElement ? "Radius (size)" : "Corner radius" }),
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "slider-container", children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              "input",
              {
            ...
            /* @__PURE__ */ jsxRuntime.jsx("span", { className: "slider-value", children: Math.round(radius) })
          ] })
        ] }),
        thickness !== null && shape instanceof timeline.LineElement && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "panel-section", children: [
          /* @__PURE__ */ jsxRuntime.jsx("label", { className: "label-dark", children: "Thickness" }),
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "slider-container", children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              "input",
              {
...
function PropertiesPanelContainer({
  ...
  const annotationTitle = selectedElement instanceof timeline.ArrowElement ? "Arrow callout" : selectedElement instanceof timeline.LineElement ? "Line" : selectedElement instanceof timeline.RectElement ? "Box" : selectedElement instanceof timeline.CircleElement ? "Circle" : null;
  const title = annotationTitle ?? (selectedElement instanceof timeline.TextElement ? selectedElement.getText() : null) ?? (selectedElement == null ? void 0 : selectedElement.getName()) ?? (selectedElement == null ? void 0 : selectedElement.getType()) ?? "Element";
  return /* @__PURE__ */ jsxRuntime.jsxs("aside", { className: "properties-panel", "aria-label": "Element properties inspector", children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "properties-header", children: [
      ...
      selectedElement && selectedElement.getType() === "caption" && /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "properties-title", children: "Subtitle" }),
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "prop-content", children: [
      ...
      selectedElement && !(selectedElement instanceof timeline.CaptionElement) && /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: (() => {
        ...
        return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          ...
          isAnnotation && /* @__PURE__ */ jsxRuntime.jsx(
...
function TwickStudio({ studioConfig }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(MediaProvider, { children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "studio-container", children: [
    !(studioConfig == null ? void 0 : studioConfig.hideHeader) && /* @__PURE__ */ jsxRuntime.jsx(
      StudioHeader,
      {
        setVideoResolution,
        onNewProject,
...
function exportProjectBundle(project, options) {
  const languages = timeline.getCaptionLanguages(project);
  const captions = (languages.length ? languages : ["default"]).map((language) => ({
    language,
    srt: timeline.exportCaptionsAsSRT(project, language),
    vtt: timeline.exportCaptionsAsVTT(project, language)
  }));
  return {
    project,
    metadata: project.metadata,
    chaptersJson: timeline.exportChaptersAsJSON(project),
    captions,
    video: {
...
exports.ChaptersPanel = ChaptersPanel;
exports.CirclePanel = CirclePanel;
exports.CloudMediaUpload = CloudMediaUpload;
exports.DEFAULT_PROJECT_TEMPLATES = DEFAULT_PROJECT_TEMPLATES;
